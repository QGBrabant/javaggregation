 ...
 * @author qgbrabant
 */
public class DistributiveLatticeArrayImpl extends HashSet<IndexedBTuple> implements Poset<IndexedBTuple>, DistributiveLattice<IndexedBTuple>{
    ...
    public <U extends BTupleImpl, T extends DistributiveLattice<U> & Set<U>> DistributiveLatticeArrayImpl(T L) {
        super();
        ...
        theGreatArrayOfSupremumPrecomputation = new IndexedBTuple[this.size()][this.size()];
